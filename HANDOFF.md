...
- **网站下载**：public/downloads/strideos-android.apk，入口在「我的」页；更新 APK 后替换文件并部署
...
*Last update: 2026-07-15 — Security (login lockout/rate-limit, headers, origin checks); migration 0005 auth_rate_limits*
