...
- Password policy: min 8, letter+digit; dummy hash verify for unknown users
...
- **下载双通道**（发版请同步）：
  1. GitHub Releases：https://github.com/z17code/StrideOS/releases（资产名 `strideos-android.apk`，tag 建议 `android-vX.Y.Z`）
  2. 网站「我的」页：`public/downloads/strideos-android.apk` → `/downloads/strideos-android.apk`
...
- [x] 网站「我的」页 Android APK 下载（/downloads/strideos-android.apk）
- [x] GitHub Releases 分发 Android APK（双通道）
...
*Last update: 2026-07-15 — Security (login lockout/rate-limit, headers, origin checks); migration 0005; GitHub Releases APK + CI/License/issue templates*
