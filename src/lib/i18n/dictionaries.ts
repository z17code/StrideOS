...
const zh = {
  ...
  me: {
    ...
    preferences: "偏好",
    preferencesHint: "语言、界面样式、外观与主题色仅对本设备生效",
    uiStyle: "界面样式",
    uiStyleHint: "可切换苹果风或经典；后续会增加更多样式",
    appearance: "外观",
    themeSystem: "跟随系统",
    themeLight: "浅色",
    themeDark: "深色",
...
const en = {
  ...
  me: {
    ...
    preferencesHint:
      "Language, UI style, appearance, and accent apply on this device",
    uiStyle: "UI style",
    uiStyleHint: "Apple or Classic; more skins later",
